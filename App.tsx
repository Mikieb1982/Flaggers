...
// Sub-component defined BEFORE it is used to prevent initialization errors
const CoinSlot = () => (
            ...
            <div className="relative w-full h-full bg-black overflow-hidden rounded-lg border-2 border-[#111] shadow-[inset_0_0_40px_rgba(0,0,0,1)]">
              ...
              {!gameStarted && (
                  <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/80 backdrop-blur-[1px]">
                        <h2 className="text-yellow-400 text-2xl md:text-4xl font-['Press_Start_2P'] mb-8 drop-shadow-lg animate-pulse">INSERT COIN</h2>
...
export default App;  const handleJump = () => {
      inputRef.current.jump = true;
  };
