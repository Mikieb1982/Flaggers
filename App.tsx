...
const App: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col select-none touch-none overflow-hidden">

      {/* 1. SCREEN SECTION (Top Half) */}
      <div className="relative w-full h-1/2 bg-black flex items-center justify-center p-4">
